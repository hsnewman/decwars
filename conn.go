...
// connection.
// Adapted from github.com/ziutek/telnet by Harris Newman
//
// License: This project is licensed under the GNU General Public License v3.0 or later (GPL-3.0-or-lat
er).
...
// notes:
//   c.cliEcho = true/c.will(o) results in putty not working (no echoing back)
//   c.cliEcho = false/c.will(o) results in putty not working (no echoing back)
//   c.cliecho = true/c.wont(o) results in echoing in putty (carrage return no workie)
//   c.cliecho - false/c.wont(o) results in echoing in putty (carrage return no workie)
//   so always should have c.wont(o) for echo
//   err = c.do(o) + c.wont(o) works:
//   results in echoing on both putty and htmlterm
//
package telnet
